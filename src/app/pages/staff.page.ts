                ...
                <tr *ngFor="let s of staff">
                  ...
                  <td>
                    <div
                      ...
                      [style.background]="s.efficiency > 80 ? '#e6f7ef' : '#fef3c7'"
                    >
                      {{ s.efficiency }}%
                    </div>
                  </td>
                  ...
                  <td>
                    <span
                      class="status-dot"
                      [style.background]="s.online ? '#10b981' : '#ccc'"
                    ></span>
                  ...
                  <td>
                    <div style="display: flex; gap: 8px;">
                      ...
                      <button class="icon-btn-small" title="Revoke" style="color: #ef4444;">
