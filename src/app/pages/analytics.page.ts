...
@Component({
        ...
        <div class="chart-card wide">
          ...
          <div class="line-chart-container">
            <svg viewBox="0 0 800 200" class="line-chart">
              ...
              <!-- Rental Path -->
              <path d="M0,150 L100,130 L200,140 L300,110 L400,90 L500,100 L600,70 L700,50 L800,40"
                    fill="none" stroke="#10b981" stroke-width="3" stroke-linecap="round" />

              <!-- Commercial Path -->
              <path d="M0,160 L100,150 L200,155 L300,140 L400,130 L500,120 L600,110 L700,90 L800,85"
                    fill="none" stroke="#1a1a1a" stroke-width="3" stroke-linecap="round" stroke-dasharray="8,4" />
  ...
  styles: [`
    ...
    .chart-card { background: white; border-radius: 20px; padding: 25px; border: 1px solid #efefef; box-shadow: 0 4px 20px rgba(0,0,0,0.03); }
    ...
    h3 { font-size: 16px; font-weight: 700; color: #1a1a1a; margin-bottom: 5px; }
    ...
    .dot.commercial { border: 2px solid #1a1a1a; }

    .line-chart-container { margin-top: 10px; }
    .line-chart { width: 100%; height: 200px; overflow: visible; }
    .x-axis { display: flex; justify-content: space-between; margin-top: 10px; color: #999; font-size: 10px; font-weight: 600; }

    .bar-chart-container { display: flex; flex-direction: column; gap: 18px; margin-top: 20px; }
    .bar-item { display: flex; align-items: center; gap: 15px; }
    .bar-label { width: 100px; font-size: 12px; font-weight: 600; color: #555; }
    .bar-track { flex: 1; height: 32px; background: #f8f9fa; border-radius: 6px; position: relative; overflow: hidden; }
    .bar-fill { height: 100%; background: #1a1a1a; display: flex; align-items: center; justify-content: flex-end; padding-right: 12px; transition: width 1s ease-out; }
    .bar-val { color: white; font-size: 10px; font-weight: 700; }

    .donut-container { display: flex; justify-content: center; margin-top: 25px; }
    .donut-chart { width: 140px; height: 140px; border-radius: 50%; background: conic-gradient(#1a1a1a 0% 45%, #666 45% 80%, #eee 80% 100%); display: flex; align-items: center; justify-content: center; position: relative; }
    ...
    .donut-hole .total { font-size: 14px; font-weight: 800; color: #1a1a1a; }
    .donut-hole .label { font-size: 9px; color: #999; text-transform: uppercase; font-weight: 600; }

    .source-list { margin-top: 25px; display: flex; flex-direction: column; gap: 12px; }
    .source-item { display: flex; align-items: center; gap: 10px; font-size: 12px; }
    .swatch { width: 10px; height: 10px; border-radius: 3px; }
    .swatch.commercial { background: #1a1a1a; }
    .swatch.residential { background: #666; }
    .swatch.land { background: #eee; border: 1px solid #ddd; }
    .source-item .name { flex: 1; color: #555; }
    .source-item .val { font-weight: 700; color: #1a1a1a; }

    .insight-item { display: flex; gap: 15px; margin-top: 20px; padding-bottom: 15px; border-bottom: 1px solid #f9f9f9; }
    .insight-item:last-child { border-bottom: none; }
    .i-title { font-size: 13px; font-weight: 700; color: #1a1a1a; margin-bottom: 2px; }
    .i-desc { font-size: 11px; color: #666; line-height: 1.4; }
  `]
})
