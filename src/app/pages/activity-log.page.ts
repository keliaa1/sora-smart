        ...
        <div class="log-card">
          <div class="log-item" *ngFor="let l of logs">
            ...
            <div class="log-details">
              <p class="log-text">
                <strong>{{ l.user }}</strong> {{ l.action }} <strong>{{ l.target }}</strong>
              </p>
  ...
  logs = [
    {
      time: '10:42 AM',
      user: 'Jean Bosco',
      action: 'completed survey for',
      target: 'Commercial House #284',
      district: 'Gasabo',
      type: 'Survey',
      icon: 'check_circle',
      bg: '#10b981',
    ...
    },
    {
      time: 'Yesterday',
      user: 'Alice Smith',
      action: 'registered new landlord',
      target: 'Mutanguha Eric',
      district: 'Nyarugenge',
      type: 'Landlord',
      icon: 'person_add',
      bg: '#3b82f6',
